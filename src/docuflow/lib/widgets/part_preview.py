...
class PartPreview:
    ...
    def render(self):
        ...
        try:
            return ui.image(self.svg_path).style(f"width: {self.size}; height: {self.size}; object-fit: contain;")
        except Exception:
    ...
    def _render_placeholder(self, label: str = "No Preview"):
        ...
        with ui.card().classes('items-center justify-center bg-zinc-800 border border-zinc-700 shadow-inner') \
