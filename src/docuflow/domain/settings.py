...
class SettingsRegistry:
    ...
    _admin: Optional[Any] = None  # AdminSystem reference for DB access
    ...
    def get_schema(self, module_name: str) -> Optional[Type[BaseModuleSettings]]:
    ...
    def get_settings_object(self, node_id: str, module: str) -> Optional[BaseModuleSettings]:
