    ...
    async function handleSaveAsNewOrder() {
        ...
        try {
            ...
            const projectData = {
                ...
                inventory: inventory,
                stock: [], // Could populate if we tracker stock usage
                params: {
                    nestingMode,
                },
            };
    ...
    <div class="workspace">
        ...
        <div class="properties-panel">
            <div class="mode-selector">
                ...
                >
                <button
                    class:active={propertyMode === "stock"}
                    onclick={() => (propertyMode = "stock")}>Stock</button
                >
            </div>
            ...
            {:else if propertyMode === "inventory"}
                ...
                {/if}
            {:else if propertyMode === "stock"}
                <!-- Stock Mode -->
                <h3>Stock / Materials</h3>
                <div class="prop-group">
                    <p class="hint-text">Manage available materials here.</p>
                </div>
                <div class="inventory-list">
                    ...
                    <button
                        ...
                        onclick={() => {
                            // Future: Open full stock editor
                            alert(
                                "Full Stock Editor not implemented in this view yet.",
                            );
                        }}>Manage Full Stock</button
                    >
                </div>
