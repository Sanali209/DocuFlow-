<script>
    ...
    async function addAssignee(task, assignee) {
        try {
            // Optimistic update
    ...
    async function removeAssignee(task, assigneeId) {
        try {
                ...
                <div class="task-item">
                    ...
                    <div class="task-line-2">
                        <div class="assignee-container">
                            ...
                            <div class="assignee-add-wrapper">
                                <select
                                ...
                                >
                                    ...
                                    {#each assignees as asg}
                                        {#if !task.assignees || !task.assignees.some((a) => a.id === asg.id)}
                                            <option value={asg.id}
                                                >{asg.name}</option
                                            >
                                        {/if}
                            ...
                            <button
                                class="assignee-manage-btn"
                                onclick={openAssigneeLibrary}
                                title="Manage Assignees Library">⚙️</button
                            >
                        </div>
                        {#if task.material}
                            <span
...
<style>
    ...
    .assignee-select {
        ...
        cursor: pointer;
        appearance: none; /* Hide default arrow to look like a button */
        width: 45px;
        text-align: center;
    }
