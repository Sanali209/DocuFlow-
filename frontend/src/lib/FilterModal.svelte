<script>
    ...
    function toggleTaskType(type) {
        if (localFilters.filterTaskTypes.includes(type)) {
            localFilters.filterTaskTypes = localFilters.filterTaskTypes.filter(
                (t) => t !== type,
            );
        } else {
            localFilters.filterTaskTypes = [
        ...
        <div class="modal-content" onclick={(e) => e.stopPropagation()}>
            ...
            <div class="modal-body">
                <div class="filter-section">
                    <h4>Document Type</h4>
                    <select
                        bind:value={localFilters.filterType}
                        class="filter-input"
                    >
                ...
                <div class="filter-section">
                    <h4>Status</h4>
                    <select
                        bind:value={localFilters.filterStatus}
                        class="filter-input"
                    >
                ...
                <div class="filter-section">
                    <h4>Material</h4>
                    <select
                        bind:value={localFilters.filterMaterial}
                        class="filter-input"
                    >
                ...
                <div class="filter-section">
                    ...
                    <div class="checkbox-group">
                        <label class="checkbox-label">
                            <input
                                type="checkbox"
                                checked={localFilters.filterTaskTypes.includes(
                                    "planned",
                                )}
                ...
                <div class="filter-section">
                    <h4>Date Range</h4>
                    <select
                        bind:value={localFilters.dateField}
                        class="filter-input"
                    >
