            ...
            <div class="card">
                <div class="card-header">
                    ...
                    >
                        <option
                            value="unregistered"
                            disabled={doc.status !== "unregistered"}
                            >Unregistered</option
                        >
                ...
                {#if (doc.tags && doc.tags.length > 0) || (doc.attachments && doc.attachments.length > 0) || taskCounts || journalCounts}
                    <div class="badges-tags-row">
                        ...
                        {#if doc.attachments && doc.attachments.length > 0}
                            <button
                                class="icon-badge attachment-badge"
                                onclick={() =>
                                    openImagePreview(doc.attachments)}
                        ...
                        {#if taskCounts}
                            {#if taskCounts.planned > 0}<span
                                    class="icon-badge task-planned"
                                    title="Planned Tasks"
                                    >📅 {taskCounts.planned}</span
                                >{/if}
                            {#if taskCounts.pending > 0}<span
                                    class="icon-badge task-pending"
                                    title="Pending Tasks"
                                    >⏳ {taskCounts.pending}</span
                                >{/if}
                            {#if taskCounts.done > 0}<span
                                    class="icon-badge task-done"
                                    title="Completed Tasks"
                                    >✅ {taskCounts.done}</span
                                >{/if}
                        {/if}

                        {#if journalCounts}
                            {#if journalCounts.info > 0}<span
                                    class="icon-badge journal-info"
                                    title="Info Notes"
                                    >ℹ️ {journalCounts.info}</span
                                >{/if}
                            {#if journalCounts.warning > 0}<span
                                    class="icon-badge journal-warning"
                                    title="Warnings"
                                    >⚠️ {journalCounts.warning}</span
                                >{/if}
                            {#if journalCounts.error > 0}<span
                                    class="icon-badge journal-error"
                                    title="Errors"
                                    >❌ {journalCounts.error}</span
                                >{/if}
                        {/if}
                    </div>
                {/if}
                ...
                <div class="card-actions">
                    <!-- Primary action: Register or View -->
