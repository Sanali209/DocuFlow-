...
from docuflow.domain.entities.production import (
    WorkItemStatus, TaskItem, ProductionUnit, MaterialType, ChatMessage
)
...
def test_chat_message_tree():
    ...
    parent = ChatMessage(id=1, author="user1", message_type="MESSAGE", content="Hello", node_id="MASTER")
    child = ChatMessage(id=2, author="user2", message_type="MESSAGE", content="Hi", node_id="SLAVE_1", parent_message_id=1)
