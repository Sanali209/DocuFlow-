"""
E2E тест портала проектов.

Требует запущенного приложения на localhost:8080 (или 8082).
"""
...
@pytest.mark.skip(reason="Requires running app and manual setup")
def test_root_redirects_or_shows_login(page: Page):
    """Basic smoke E2E: ensure the app serves the portal/login page.

    Note: the application must be running locally (default port 8080) for this test.
    """
