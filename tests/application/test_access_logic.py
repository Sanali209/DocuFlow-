import json
import pytest
from docuflow.domain.entities.identity import User, Role, Workplace
...
@pytest.fixture
def laser_workplace():
    return Workplace(id=10, node_id="LASER_01", name="Laser", allowed_modules=json.dumps(["tracking", "inventory"]))
